...
##
##precf <- "data/cajamarca_monthly_precipitation_vL.grd"
prec <- stack(precf)
prec



## ----eval=TRUE,warnig=FALSE,message=FALSE-------------------------------------
...
## ----eval=TRUE,warning=FALSE,ercho=FALSE,message=FALSE------------------------
